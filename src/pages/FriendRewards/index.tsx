      ...
      <div>
        ...
        >
          <div className="mt-4 mx-3">
            {/* 친구 이름 검색 */}
            <p className="text-lg font-medium text-left mb-2">검색</p>
            ...
            {/* 자산 종류 필터 (하나만 선택) */}
            <p className="text-lg font-medium text-left mb-2">자산 종류</p>
            ...
            {/* 날짜 범위 선정 */}
            <p className="text-lg font-medium text-left mt-4">날짜 범위</p>
